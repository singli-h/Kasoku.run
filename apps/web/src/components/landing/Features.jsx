...
import { Activity, Brain, Calendar, ChartLine, Clock, Users } from 'lucide-react'
...
const FeatureCard = ({ icon: Icon, title, description, index }) => {
  return (
    <motion.div
      ...
      className="relative p-6 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300"
    >
      <div className="absolute -top-4 -left-4 p-3 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl shadow-lg">
