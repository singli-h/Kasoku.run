...
export default function PresetGroupEditPage() {
  ...
  const handleSaveChanges = async (updatedData) => {
    ...
    try {
      ...
      router.push('/plans?tab=builder'); // Navigate back to the builder tab on the plans page
    } catch (error) {
  ...
  return (
    <div className="container mx-auto p-4">
      <Button variant="ghost" onClick={() => router.push('/plans?tab=builder')} className="mb-4">
      ...
      <GroupEditorView
        ...
        onBack={() => router.push('/plans?tab=builder')}
