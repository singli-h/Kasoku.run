...
const DEMO_SPRINT_SESSIONS = [
  {
    ...
    isPB: true,
    splits: [
      { distance: 20, time: 2.95, cumulativeTime: 2.95 },
      { distance: 40, time: 1.83, cumulativeTime: 4.78 },
      { distance: 60, time: 1.74, cumulativeTime: 6.52 },
    ],
  },
  {
    id: "s2",
    ...
    isPB: false,
    splits: [
      { distance: 20, time: 2.98, cumulativeTime: 2.98 },
      { distance: 40, time: 1.87, cumulativeTime: 4.85 },
    ],
  },
  {
    id: "s3",
    ...
    isPB: false,
    splits: [
      { distance: 20, time: 3.02, cumulativeTime: 3.02 },
      { distance: 40, time: 1.89, cumulativeTime: 4.91 },
    ],
  },
]
...
const DEMO_ATHLETE_METRICS = {
  ...
  reactionTime: 0.133,
  topSpeed: 11.2,
  strideLengthMaxV: 2.42,
  strideFrequencyMaxV: 4.63,
  bestTime: 6.52,
  bestDistance: 60,
}
