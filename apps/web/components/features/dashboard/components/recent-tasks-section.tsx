...
import { ExternalLink, Dumbbell, Calendar } from "lucide-react"
...
export function RecentSessionsSection({ sessions }: RecentSessionsSectionProps) {
  const getStatusConfig = (status: string) => {
    switch (status) {
      ...
      default:
        return { variant: 'outline' as const, label: 'Pending', color: 'bg-gray-400' }
    }
  }
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        <Badge 
                          ...
                          className={cn(
                            "text-xs",
                            session.status === 'pending' && "bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-200",
