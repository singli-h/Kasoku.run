...
import { Bot, Check, RefreshCw, X, Loader2, AlertCircle, ChevronDown, ChevronUp } from 'lucide-react'
...
export function ApprovalBanner({
  ...
  const [isExpanded, setIsExpanded] = useState(true) // Show changes by default
