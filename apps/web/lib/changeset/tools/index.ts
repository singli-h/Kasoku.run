...
export {
  proposalTools,
  // New aligned naming (SessionPlan prefix)
  createSessionPlanChangeRequestTool,
  createSessionChangeRequestSchema,
  updateSessionPlanChangeRequestTool,
  updateSessionChangeRequestSchema,
  createSessionPlanExerciseChangeRequestTool,
  createExerciseChangeRequestSchema,
  updateSessionPlanExerciseChangeRequestTool,
  updateExerciseChangeRequestSchema,
  deleteSessionPlanExerciseChangeRequestTool,
  deleteExerciseChangeRequestSchema,
  createSessionPlanSetChangeRequestTool,
  createSetChangeRequestSchema,
  updateSessionPlanSetChangeRequestTool,
  updateSetChangeRequestSchema,
  deleteSessionPlanSetChangeRequestTool,
...
export {
  ...
  // New aligned naming (WorkoutLog prefix)
  createWorkoutLogSetChangeRequestTool,
  createWorkoutLogSetChangeRequestSchema,
  updateWorkoutLogSetChangeRequestTool,
  updateWorkoutLogSetChangeRequestSchema,
  deleteWorkoutLogSetChangeRequestTool,
  deleteWorkoutLogSetChangeRequestSchema,
  createWorkoutLogExerciseChangeRequestTool,
  createWorkoutLogExerciseChangeRequestSchema,
  updateWorkoutLogExerciseChangeRequestTool,
  updateWorkoutLogExerciseChangeRequestSchema,
  deleteWorkoutLogExerciseChangeRequestTool,
  deleteWorkoutLogExerciseChangeRequestSchema,
  updateWorkoutLogChangeRequestTool,
  updateWorkoutLogChangeRequestSchema,
  // DEPRECATED: Legacy aliases for backwards compatibility
  ...
  // Types (new)
  type CreateWorkoutLogSetInput,
  type UpdateWorkoutLogSetInput,
  type DeleteWorkoutLogSetInput,
  type CreateWorkoutLogExerciseInput,
  type UpdateWorkoutLogExerciseInput,
  type DeleteWorkoutLogExerciseInput,
